...
tag1='Legacy2018_24May2021'
tag2='Legacy2018_21Jul2021'
...
#massval = [250,270,300,350,400,450,500,550,600,650,750,900]
...
legend.AddEntry(grexp1, "Results with improvements", "l")
legend.AddEntry(grexp2, "Results without improvements", "l")
...
hframe2.GetYaxis().SetTitle("#frac{Improved}{Not improved}")
hframe2.SetStats(0)
...
c1.SaveAs("plots/massScan_withdummy_combined"+".png")
# for m in masses :
