...
legend.AddEntry(grexp1, "tot_bkg_thr=1, BayesOpt", "l")
legend.AddEntry(grexp2, "Old binnings", "l")
...
hframe2.GetYaxis().SetTitle("#frac{tot_bkg_thr=1}{Old binnings}")
hframe2.SetStats(0)
...
c1.SaveAs("plots/massScan_BinOptKons_combined"+".pdf","pdf")
# for m in masses :
