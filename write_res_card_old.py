...
#        "0"  : "DNNoutSM_kl_1_HHKin_mass_raw",
#        "1"  : "DNNoutSM_kl_1_HHKin_mass_raw",
#        "2"  : "DNNoutSM_kl_1_HHKin_mass_raw",
#        "3"  : "DNNoutSM_kl_1_HHKin_mass_raw",
#        "4"  : "DNNoutSM_kl_1_HHKin_mass_raw", # "mdnn__v2__kl1_c2v1_c31__hh_vbf",
...
if opt.overSel == "" :
    if opt.channel is "TauTau":
	allSel = ["s1b1jresolvedMcut", "s2b0jresolvedMcut", "sboostedLLMcut", "VBFloose"]
    else:
    	allSel = ["s1b1jresolvedMcut", "s2b0jresolvedMcut", "sboostedLLMcut", "VBFloose", "s1b1jresolvedMcutInvDR", "s2b0jresolvedMcutInvDR", "sboostedLLMcutInvDR", "VBFlooseInvDR"]
