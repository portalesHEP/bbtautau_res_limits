...
colors=[ROOT.kBlue+2,ROOT.kAzure+10,ROOT.kViolet,ROOT.kGreen+2]

var = 'DNNoutSM_kl_1'

#tag = 'CombChan2018_res_Legacy2018_25Mar2021_m'
#tag='CombChan2018_res_17Feb2021'
tag = 'TauTauLegacy2018_20Apr2021'
tag2 = 'TauTauLegacy2018_06Apr2021'
...
for i in range(len(selections)):
	...
	massval = [250, 260, 270, 300, 320, 350, 400, 450, 500, 550, 600, 650, 700, 750, 800, 850, 900, 1000, 1250, 1500, 1750, 2000, 2500, 3000]
    for mass in massval:
        fName = 'cards_'+tag+'/'+sel+'/combined_out/comb.Radion{0}.log'.format(mass)
       	fName2 = 'cards_'+tag2+'/'+sel+'/combined_out/comb.Radion{0}.log'.format(mass)
	#fName = 'cards_'+tag+'/'+sel+var+'/comb.{1}.Radion{0}.log'.format(mass,sel)


        exp   = parseFile(fName)/parseFile(fName2)           
...
hframe.GetYaxis().SetTitle("Ratio of upper limit, #frac{new binnings}{old binnings}")
...
c1.Print("plots/massScan_Compare"+tag+".pdf","pdf")
