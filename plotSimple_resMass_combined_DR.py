...
tag1='Legacy2018_29Mar2021_m'
tag2='Legacy2018_25Mar2021_m'
...
legend.AddEntry(grexp1, "Including events with #DeltaR < 0.5", "l")
legend.AddEntry(grexp2, "Not including events with #DeltaR < 0.5", "l")
...
pt = ROOT.TPaveText(0.1663218-0.06,0.886316,0.3045977-0.06,0.978947,"brNDC")
pt.SetBorderSize(0)
pt.SetTextAlign(12)
pt.SetTextFont(62)
pt.SetTextSize(0.06)
...
pt2 = ROOT.TPaveText(0.736111-0.03,0.9066667,0.847222-0.03,0.954641,"brNDC")
pt2.SetBorderSize(0)
pt2.SetFillColor(0)
...
pt4 = ROOT.TPaveText(0.4819196+0.036-0.05,0.7780357+0.015,0.9008929+0.036-0.05,0.8675595+0.015,"brNDC")
pt4.SetTextAlign(12)
pt4.SetFillColor(ROOT.kWhite)
pt4.SetFillStyle(1001)
pt4.SetTextFont(42)
pt4.SetTextSize(0.06)
pt4.SetBorderSize(0)
pt4.SetTextAlign(32)
...
hframe2.GetXaxis().SetTitleOffset(0.9)

hframe2.GetXaxis().SetTitle("m_{S} [GeV]")
hframe2.GetYaxis().SetTitle("#frac{With #DeltaR<0.5}{w/o #DeltaR<0.5}")
hframe2.SetStats(0)
...
c1.SaveAs("plots/massScan_DR_combined"+".pdf","pdf")
# for m in masses :
