...
tag="cards_Legacy2018_01Apr2021"
...
mkdir $tag/combined_out
for mass in $masses
do
    echo $mass
    combine -M AsymptoticLimits /data_CMS/cms/liugeliang/HHbbtautau_limits/$tag/comb.Radion$mass.root -n $identifier --run blind --noFitAsimov -m $mass --freezeParameters SignalScale > /data_CMS/cms/liugeliang/HHbbtautau_limits/$tag/combined_out/comb.Radion$mass.log
done
