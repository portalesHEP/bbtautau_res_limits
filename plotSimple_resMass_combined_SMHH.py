...
tag1='Legacy2018_25Mar2021'
tag2='2018_Legacy2018_test'
...
legend.AddEntry(grexp1, "Including SM HH as a background", "l")
legend.AddEntry(grexp2, "Not including SM HH as a background", "l")
...
hframe2.GetYaxis().SetTitle("#frac{with SMHH}{w/o SMHH}")
hframe2.SetStats(0)
...
c1.SaveAs("plots/massScan_SMHH_combined"+".pdf","pdf")
# for m in masses :
