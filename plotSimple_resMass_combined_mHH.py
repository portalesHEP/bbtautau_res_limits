...
tag1='Legacy2018_11Oct2021'
tag2='Legacy2018_24May2021'
...
legend.AddEntry(grexp1, "Fit using HHKin_mass_raw", "l")
legend.AddEntry(grexp2, "Fit using DNNoutSM_kl_1", "l")
...
hframe2.SetMinimum(0.4)
hframe2.SetMaximum(2)
...
hframe2.GetYaxis().SetTitle("#frac{using HHKin_mass_raw}{using DNNoutSM_kl_1}")
hframe2.SetStats(0)
...
c1.SaveAs("plots/massScan_mHH_combined"+".pdf","pdf")
# for m in masses :
