...
legend.AddEntry(grexp1, "After binning optimization", "l")
legend.AddEntry(grexp2, "Using old binning schemes", "l")
...
hframe2.GetYaxis().SetTitle("#frac{Optimized binnings}{Old binnings}")
hframe2.SetStats(0)
...
c1.SaveAs("plots/massScan_BinOptJona_combined"+".pdf","pdf")
# for m in masses :
