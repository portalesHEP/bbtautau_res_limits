...
#masses="400 450 500 550 600 650 700 750 800 850 900 1000 1250 1500 1750 2000 2500 3000"
#masses="250"
var="HHKin_mass_raw"
...
tag="cards_Legacy2018_11Oct2021"
...
do
    echo $mass
    combine -M AsymptoticLimits $tag/comb.Radion$mass.txt -n $identifier --run blind --noFitAsimov -m $mass --freezeParameters SignalScale > $tag/combined_out/comb.Radion$mass.log
done
