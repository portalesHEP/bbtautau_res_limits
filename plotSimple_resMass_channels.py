...
tag = 'CombChan2018_res_Legacy2018_29Mar2021_m'
...
for sel in selections:
	...
	massval = [250, 260, 270, 300, 320, 350, 400, 450, 500, 550, 600, 650, 700, 750, 800, 850, 900, 1000, 1250, 1500, 1750, 2000, 2500, 3000]
    for mass in massval:
        fName = 'cards_'+tag+'/'+sel+var+'/combined_out/comb.Radion{0}.log'.format(mass)
...
#    legend.AddEntry(grobs,"Observed","l")
    ...
    c1.Print("plots/massScan_"+tag+"_"+sel+".pdf","pdf")
    #c1.Print("plots/massScan_"+tag+"_"+sel+".pdf", 'pdf')
# for m in masses :
