...
for mass in massval:
   ...
   fName = 'cards_'+tag+'/combined_out/comb.Radion{0}.log'.format(mass)
   ...
   print mass,exp,m1s_t,p1s_t,m2s_t,p2s_t
...
#c1.SaveAs("plots/massScan_"+tag+"_combined"+".pdf","pdf")
c1.SaveAs("plots/massScan_"+tag+"combined.png")
# for m in masses :
